...
const User = ({ ownId, user, setShowUserProfile }) => {
  ...
  return (
    <div>
      ...
      {follows && <PersonalInfo ownId={ownId} user={user} type="user" handleUpdateFollows={handleUpdateFollows} follows={follows} limitedInfo={chatNotAllowed} setShowUserProfile={setShowUserProfile} setPosts={setPosts} />}
